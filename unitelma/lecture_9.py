...
if __name__ == '__main__':
    # ex 1 test
    print(clines('files/testo.txt', 'err')) # print 3
    print(clines('files/testo.txt', 'Errori')) # print 2

    # ex 2 test
    print(all_char('files/testo.txt', 'utf8')) # print 'SUGLI ERO\nlierosnvtab.èum,pdcNq()'

    # ex 3 test
    print(anagrams('files/alice.txt', 'read')) # print ['dear', 'read', 'dare']
