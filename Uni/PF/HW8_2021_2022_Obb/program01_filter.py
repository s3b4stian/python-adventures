...
def filter_diff(m: list, c: int, x: int, y: int)->bool:
    """
    Checks if the 2x2 matrix passes as argument match the pattern, this check
    is used when a new pixel need to be added to the matrix.
    ...
    ----------
    m : list
        Matrix to check, at least 2x2.
    c : int
        The pixel being added to the matrix.
    x : int
    ...
    -------
    bool
        True if the matrix match the pattern False otherwise.
...
def filter_cross(m: list, c: int, x: int, y: int)->bool:
    """
    Checks if the 2x2 matrix passes as argument match the pattern, this check
    is used when a new pixel need to be added to the matrix.
...
def filter_hrect(m: list, c: int, x: int, y: int)->bool:
    """
    Checks if the 2x2 matrix passes as argument match the pattern, this check
    is used when a new pixel need to be added to the matrix.
...
def filter_vrect(m: list, c: int, x: int, y: int)->bool:
    """
    Checks if the 2x2 matrix passes as argument match the pattern, this check
    is used when a new pixel need to be added to the matrix.
